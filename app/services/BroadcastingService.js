...
function broadcast (currentUUID) {
  ...
  AndroidBLEAdvertiserModule.broadcast(currentUUID, MANUFACTURER_DATA)
    .then(success =>
      console.log('[Bluetooth]', nowStr(), currentUUID, 'Broadcasting Sucessful', success)
    )
...
function stopBroadcast (currentUUID) {
  ...
  AndroidBLEAdvertiserModule.stopBroadcast()
    .then(success =>
      console.log('[Bluetooth]', nowStr(), currentUUID, 'Stop Broadcast Successful', success)
    )
    .catch(error =>
      console.log('[Bluetooth]', nowStr(), currentUUID, 'Stop Broadcast Error', error)
    )

  //console.log('[Bluetooth]', nowStr(), currentUUID, "Stopping Scanning");
  AndroidBLEAdvertiserModule.stopScan()
    .then(success =>
      console.log('[Bluetooth]', nowStr(), currentUUID, 'Stop Scan Successful', success)
    )
