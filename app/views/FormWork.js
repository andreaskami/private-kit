    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.headerContainer}>
          ...
          <Text style={styles.headerTitle}>{languages.t('label.FORMWORK')}</Text>
        </View>
        <ScrollView contentContainerStyle={styles.main}>
          ...
          <TextInput
            ...
            style={styles.input}
          />
          <Text style={styles.label}>{languages.t('label.FORMWORK_COMPANY')}</Text>
          <TextInput
            onChangeText={company => this.setState({ company })}
            value={this.state.company}
            style={styles.input}
          />
          <Text style={styles.label}>{languages.t('label.FORMWORK_IDENTIFICATION')}</Text>
          <TextInput
          ...
          <TextInput
            ...
            style={styles.input}
          />
          <Text style={styles.label}>{languages.t('label.FORMWORK_TIMES')}</Text>
          ...
          <Text style={styles.label}>{languages.t('label.FORMWORK_SUPERVISOR')}</Text>
          <TextInput
